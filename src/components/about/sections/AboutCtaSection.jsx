...
const WHATSAPP_URL =
  "https://api.whatsapp.com/send?phone=18889981004&text=Hi%20King%20Moving%20Services%2C%20I%27d%20like%20support%20with%20my%20move.";
    ...
    >
      ...
      >
        ...
        <div className="mt-10 flex w-full max-w-5xl flex-col gap-4 md:mt-12 md:flex-row md:items-stretch md:justify-center md:gap-5">
          ...
          <a href="tel:+18889981004" className={`${btnOnDark} bg-primary`}>
            ...
            <span className="leading-snug">
              Call toll-free&nbsp;
              <span className="whitespace-nowrap">888-998-1004</span>
              <span className="hidden sm:inline"> · Ext. 101</span>
            </span>
          </a>
        ...
        <p className="mt-8 max-w-xl text-sm font-medium text-foreground/55 md:text-base">
          Direct line:&nbsp;
          <a href="tel:+14804471200" className="text-primary underline-offset-2 hover:underline">
            480-447-1200
          </a>
          &nbsp;·&nbsp;
          <a
